// This is a test file - use tsx to run it
// $ npm run test:entities (add to package.json) or tsx test-entities-api.mjs
...
async function main() {
  ...
  const { entityQueryService } = await import("./src/services/entity-query.js");
  ...
  if (entities.length === 0) {
    ...
    const withWiki = entities.filter((e) => e.wikipediaUrl).length;
